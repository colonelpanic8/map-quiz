...
const worldCountryProjectionOptions: QuizProjectionOption[] = [
  {
    id: 'naturalEarth1',
    label: 'Natural Earth',
...
const worldCountriesQuiz = createWorldCountriesQuiz(
  'world-countries',
  'naturalEarth1',
)

const worldCountriesEqualEarthQuiz = createWorldCountriesQuiz(
  'world-countries-equal-earth',
  'equalEarth',
)

const worldCountriesMercatorQuiz = createWorldCountriesQuiz(
